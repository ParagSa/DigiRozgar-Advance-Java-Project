...
const BASE_URL = 'http://localhost:8011/user';
...
const BASE_URL12 = 'http://localhost:8011/user/byemail';
...
const BASE_URL13 = 'http://localhost:8011/admin';
...
const BASE_URL1 = 'http://localhost:8011/user/byemail';
...
const BASE_URL2 = "http://localhost:8011/postjob";
...
const BASE_URL10 = "http://localhost:8011/contact";
...
const BASE_URL4 = "http://localhost:8011/user";
...
const BASE_URL5 = "http://localhost:8011/admin";
...
const BASE_URL6 = 'http://localhost:8011/feedback';
...
const BASE_URL7 = 'http://localhost:8011/login';
...
const BASE_URL8 = 'http://localhost:8011/persistMessage';
...
const BASE_URL9 = 'http://localhost:8011/destroy';
...
const BASE_URL11 = 'http://localhost:8011/payment';
